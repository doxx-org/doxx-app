...
export const DEFAULT_DECREASE_CLMM_SLIPPAGE = 0.01;
export const DEFAULT_CREATE_CPMM_SLIPPAGE = 0.02;
export const DEFAULT_DECREASE_CPMM_SLIPPAGE = 0.01;

export const DOXX_CLMM_PROGRAM_ID = new PublicKey(
