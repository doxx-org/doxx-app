export type DoxxClmmMainnet = {
  address: "8pQAnGbHE3y7WoBYPY8tCoNoosTNV1LPUr5YtwSMDiXg",
  metadata: {
    name: "amm_v3",
    version: "0.1.0",
    spec: "0.1.0",
  ...
  instructions: [
    ...
    },
    {
      ...
      "accounts": [
        ...
        // TODO: mainnet idl doesn't have this
        // {
        //   "name": "rent",
            ...
            "seeds": [
              {
                "kind": "const",
                "value": [
                  112, 111, 111, 108, 95, 114, 101, 119, 97, 114, 100, 95, 118,
                  97, 117, 108, 116
                ]
              },
              {
  ...
  "types": [
    ...
    },
    {
      ...
      docs: [
        "The pool state",
        "",
        "PDA of `[POOL_SEED, config, token_mint_0, tokenMint1]`",
        ""
      ],
      serialization: "bytemuckunsafe",
      repr: {
