...
import {
  LPTokenAmountTooltip,
  TokenAmountTooltip,
} from "@/components/TokenAmount";
...
import { PositionAmount } from "../../cpmm/positions/PositionAmount";
import { PositionRangeLabel } from "../../cpmm/positions/PositionRangeLabel";
    ...
    <div className="flex flex-col gap-5 border-b border-gray-800 px-4 py-5">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <PositionRangeLabel position={position} isLoading={false} />
        </div>
        ...
        <div className={cn(text.sb3(), "flex flex-col gap-2")}>
          ...
          <div className="flex items-center justify-between">
            <p className="text-gray-500">LP Staked:</p>
            <div className="flex items-center gap-1">
              <LPTokenAmountTooltip
                token1={selectedPool.lpToken.token1}
                token2={selectedPool.lpToken.token2}
                address={position.lpMint.toString()}
                amount={
                  position.lpAmountRaw
                    ? Number(position.lpAmountRaw) /
                      Math.pow(10, position.lpDecimals ?? 6)
                    : 0
                }
