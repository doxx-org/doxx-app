...
export function useGetCLMMPools(
...
): UseQueryResult<CLMMPoolStateWithConfig[] | undefined, Error> {
  return useQuery({
    queryKey: ["allClmmPoolStates"],
    queryFn: async (): Promise<CLMMPoolStateWithConfig[] | undefined> => {
