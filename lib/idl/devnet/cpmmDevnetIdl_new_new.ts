...
export type DoxxCpmmDevnet = {
  address: "CfKZVvLR1QL7MX79nnBraJBLSxB7YdxDy1QhAs3xSS5L";
  metadata: {
    name: "doxxAmm";
    version: "0.2.0";
    spec: "0.1.0";
      ...
      accounts: [
        {
          ...
          writable: true;
          signer: true;
          address: "AfVv3F5c4bPtdCrRiSuRdWitb7YKDoAzCjijQ8GUJc1W";
        },
        {
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          writable: true;
          address: "8ScAcZxZvCFkgTaaAFMn1keKbvYjF5pjSR98NtXU3uF1";
        },
        {
